...
function SessionPage() {
  ...
  // auto-join session if user is not host or participant
  useEffect(() => {
...
const submitRecording = async () => {
  ...
  formData.append("audio", videoBlob, "audio.wav")

  try {
    // call ML service directly from frontend
    ...
    // save locally — no MongoDB needed
    analysisStore.save(id, result)
    console.log("✅ Analysis saved locally:", result)

  } catch (err) {
    console.error("❌ Failed to get analysis:", err)

    // save mock data so UI still shows something
    analysisStore.save(id, {
      audio: {
      ...
      video: {
        ...
        confidence_score:  55,
        engagement_score:  60,
        emotion_breakdown: { neutral: 45, happy: 30, surprise: 15, sad: 10 },
      },
      insights: {
        overall_score:   58,
        insights:        ["Speaking pace is reasonable", "Moderate engagement detected"],
        recommendations: ["Try to smile more naturally", "Project voice with confidence"],
      },
    })
  }
}
  ...
  const handleEndSession = () => {
    if (!confirm("Are you sure you want to end this session? All participants will be notified.")) return;
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="card bg-base-100 shadow-xl max-w-md">
            <div className="card-body items-center text-center">
              ...
              <p className="text-base-content/70">This session does not exist or has been removed.</p>
